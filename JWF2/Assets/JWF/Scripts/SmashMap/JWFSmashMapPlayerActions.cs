...
{
	public class JWFSmashMapPlayerActions : PlayerActionSet
	{
		...
		public JWFSmashMapPlayerActions()
		{
		...
		public static JWFSmashMapPlayerActions CreateWithKeyboardBindings(int playerID)
		{
			var actions = new JWFSmashMapPlayerActions();
		...
		public static JWFSmashMapPlayerActions CreateWithJoystickBindings(int playerID)
		{
			var actions = new JWFSmashMapPlayerActions();
